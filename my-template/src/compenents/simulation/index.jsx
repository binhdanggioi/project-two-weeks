    ...
    return(
            <div className="simulation">
                <div className="simulation__info">
                    <div className="simulation__info--button">
                        <Button shape="circle" className="btn__large" size={size}>
                    ...
                    <div className="simulation__info--avatar">
                        <Card className="card">
                            <Badge dot offset={[-12, 95]}>
                                <Avatar className="avatar" size={80} shape="circle" />
                            </Badge>
                            <p className="name">Meagan Fisher</p>
                            <p className="job">Engineering Manager</p>
                            <div className="btn__interactive">
                                    <Button className="btn" type="primary" shape="round">Follow
                                        <svg viewBox="0 0 24 24">
                                            <path fill="#FFFFFF"
                                    ...
                                    <Button className="btn" shape="round">Message
                                        <svg viewBox="0 0 24 24">
                                            <path fill="#4E5D78"
                ...
                <div className="simulation__represent">
                    ...
                    <Card className="name">
                        <div className="name__info">
                            ...
                            {/* <div className="name__svg">
                                <p>3</p>
                            </div> */}
                        </div>
                    </Card>
                </div>
                <div className="simulation__login">
                    <Card className="login">
                        <p style={{fontSize: '22px',lineHeight: '32px',fontWeight: '500'}}>Login into your account</p>
                        <p style={{fontSize: '12px',lineHeight: '20px',color: '#A7AAB0',marginBottom: '4rem'}}>Don't have an account yet? 
                            <a style={{fontWeight: '500'}} href="https://">Create New</a>
                        </p>
                        <Formik
                        initialValues={{email: '',password:''}}
                        render={() => (
                            <Form>
                                <Input style={{borderRadius: '50px',outline: 'none',marginBottom: '1rem'}} name='email' placeholder='First Name' />
                                <Input.Password style={{borderRadius: '50px',outline: 'none',marginBottom: '1rem'}} name='password' placeholder='password' />
                                <button style={{outline: 'none',border:'none',borderRadius:'50px',marginTop: '4rem',padding:'0.5rem'}} className="btn__login">Login</button>
                            </Form>
                        )}
                            />
                    </Card>
