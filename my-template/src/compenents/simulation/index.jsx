...
import { Card,Button, Avatar, Badge,Form, Input } from 'antd';
            ...
            <div className="simulation">
                ...
                <div className="simulation__login">
                    <Card className="login">
                        ...
                        <Form>
                            <Form.Item>
                            <Input size="large" icon={MailOutlined} placeholder="johndoe@gmail.com" style={{borderRadius: '50px'}}/>
                            </Form.Item>
                            <Form.Item>
                            <Input.Password size="large" placeholder="Password" style={{borderRadius: '50px'}}/>
                            </Form.Item>
                            <Form.Item>
                                <Button className="btn__login" style={{color: '#0284FE'}} shape="round" size={size}>
                                    Login
                                </Button>
                            </Form.Item>
                        </Form>
